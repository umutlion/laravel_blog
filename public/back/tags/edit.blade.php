                            ...
                            <form action="{{route('tags.update', $tag->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                               @method('PUT')
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="text-input" placeholder="Başlık giriniz..." class="form-control" value="{{$tag->title}}" >
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="selectLg" id="selectLg" class="form-control-lg form-control">
                                            ...
                                            <option @if($tag->category_id == $category->id) selected @endif value="{{$category->id}}">{{$category->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <img src="{{asset($tag->image)}}" class="rounded img-thumbnail" width="300">
                                        <br>
                                        <br>
